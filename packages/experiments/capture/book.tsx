...
<div className="w-[14px] absolute top-0 left-0 bottom-0 z-30 h-full flex flex-row justify-end">
  ...
  <p className="text-sm text-shadow-2xs text-shadow-[rgba(255,255,255,1)] 0 font-medium absolute bottom-[8px] left-[24px] right-[8px] text-[rgba(0,0,0,0.5)]">
    ...
    <div className="absolute z-[4] inset-[4px] left-[16px] bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.2)_inset,0_2px_2px_0_rgba(255,255,255,0.1)_inset] rounded-md transition-all duration-300 group-active/book:translate-x-[6px] group-hover/book:translate-x-[6px]"></div>

    <div className="absolute z-1 shadow-[0_0_0_0.65px_rgba(0,0,0,0.1)_inset,0_2px_2px_0_rgba(255,255,255,0.1)_inset] inset-0 left-[16px] bg-[#cccccc] rounded-lg transition-all duration-300 group-active/book:translate-x-[6px] group-hover/book:translate-x-[6px]"></div>
    </div>
    </div>
  );
}
