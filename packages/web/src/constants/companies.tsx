...
export const companyData: Record<string, CompanyInfo> = {
  profound: {
    ...
    ogImage: "https://tryprofound.com",
    icon: (
      <div className="w-12 h-12 rounded-lg bg-black flex items-center justify-center p-2">
        <svg
          width="66"
          height="68"
          viewBox="0 0 66 68"
  ...
  endex: {
    name: "Endex",
    url: "https://endex.ai",
    description: "AI-powered search and knowledge platform",
    ogImage: "https://endex.ai",
    icon: (
      <img
